...
for i = 1:numAlleles-1
    for j = i+1:numAlleles
        ind = allelesToGenotypes(i, j);             % or (j, i)
        genotypeFactor.val(ind) = 2 * alleleFreqs(i) * alleleFreqs(j);
    end
end
for i = 1:numAlleles 
    ind = allelesToGenotypes(i, i);
    genotypeFactor.val(ind) = alleleFreqs(i) * alleleFreqs(i);
end
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%  