...
function allAcc = LRSearchLambdaSGD(Xtrain, Ytrain, Xvalidation, Yvalidation, lambdas)
  ...
  %%%%%%%%%%%%%%
  %%% Student code
  for i = 1:size(allAcc, 2)
      TrainedThetas_i = LRTrainSGD(Xtrain, Ytrain, lambdas(1, i));
      predictions_i = LRPredict(Xvalidation, TrainedThetas_i);
      allAcc(i) = LRAccuracy(Yvalidation, predictions_i); 
  end
  %%%%%%%%%%%  
